...
require 'PHPMailer-master/src/SMTP.php';
    ...
    class Mails {
        public static function sendEmail($cust_email, $subject, $mailContent) {
            $mail = new PHPMailer();
            ...
            $mail->SetFrom('northwrite19@gmail.com', 'Mailtrap');
            $mail->addReplyTo('northwrite19@gmail.com', 'Mailtrap');
