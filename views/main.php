	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav mr-auto">
	          ...
	          <li class="nav-item"><a href="<?php echo ROOT_URL ?>/contact/index/" class="nav-link">Contact</a></li>
	        </ul>
	      </div>
	    </div>
	  </nav>
								...
								<div class="row justify-content-center">
									<div class="col-md-12 col-lg-10">
										<div class="row">
											...
											<div class="col-md-6 mb-md-0 mb-4">
												Questions or enquiries? <a href="<?php echo ROOT_URL; ?>/contact/index/">You can send us a message</a>
