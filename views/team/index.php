      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end">
          <div class="col-md-9 ftco-animate pb-5">
          	<p class="breadcrumbs mb-2"><span class="mr-2"><a href="<?php echo ROOT_PATH; ?>">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Team <i class="ion-ios-arrow-forward"></i></span></p>
    ...
    <section class="ftco-section">
        ...
        <div class="row">
        	<div class="col-lg-3 col-sm-6">
	            ...
	            <div class="flipper">
	              <div class="front" style="background-image: url(assets/images/team-1.jpg);">
	                <div class="box">
	                  <h2>Ryan Anderson</h2>
	                  <p>Head Engineer</p>
	                </div>
        	...
        	<div class="col-lg-3 col-sm-6">
        		<div class="block-2 ftco-animate">
	            <div class="flipper">
	              <div class="front" style="background-image: url(assets/images/team-2.jpg);">
	                <div class="box">
	                  <h2>Greg Washer</h2>
	                  <p>Head Engineer</p>
	                </div>
        	...
        	<div class="col-lg-3 col-sm-6">
        		<div class="block-2 ftco-animate">
	            <div class="flipper">
	              <div class="front" style="background-image: url(assets/images/team-3.jpg);">
	                <div class="box">
        	...
        	<div class="col-lg-3 col-sm-6">
        		<div class="block-2 ftco-animate">
	            <div class="flipper">
	              <div class="front" style="background-image: url(assets/images/team-4.jpg);">
	                <div class="box">
	                  <h2>Jack Smith</h2>
	                  <p>Architect</p>
	                </div>
