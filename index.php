    ...
    getpaidSetup(
      {
        ...
        callback:function(response) {
          ...
          if (chargeResponse == "00" || chargeResponse == "0") {
            window.location = "https://youconnect.herokuapp.com/index?controller=transactions&txref="+txref+"&amt="+amount+"&cur="+currency+"&name="+cust_name; //Add your success page here
          } else {
